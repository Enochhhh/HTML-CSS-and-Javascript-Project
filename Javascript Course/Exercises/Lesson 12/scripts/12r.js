...
document.querySelector('.js-reset-score-button')
  .addEventListener('click', () => {
    document.querySelector('.js-confirm-reset-score').classList
      .add('show-element');
  });
...
document.querySelector('.js-yes-answer-button')
  .addEventListener('click', () => {
    document.querySelector('.js-confirm-reset-score')
...
document.querySelector('.js-no-answer-button')
  .addEventListener('click', () => {
    document.querySelector('.js-confirm-reset-score')
      .classList.remove('show-element');
  });
